...
public class AmountFormatUtil {
     ...
     * @return
     */
    public static String formatWithYen(BigDecimal bigDecimal) {
        return currencyFormat.format(bigDecimal);
    }

    public static String convertToChineseAmount(double amount) throws IllegalArgumentException {
        return convertToChineseAmount(numberFormat.format(amount));
    }
     ...
     */
    public static String convertToChineseAmount(String amount) throws IllegalArgumentException {
        // 去掉分隔符
