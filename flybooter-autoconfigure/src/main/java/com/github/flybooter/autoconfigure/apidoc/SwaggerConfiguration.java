package com.github.flybooter.autoconfigure.apidoc;
...
@Profile("swagger")
@AutoConfigureAfter(MyApplicationProperties.class)
@EnableSwagger2
...
public class SwaggerConfiguration {
    ...
    private final MyApplicationProperties.Swagger properties;

    public SwaggerConfiguration(MyApplicationProperties myApplicationProperties) {
        this.properties = myApplicationProperties.getSwagger();
    }
